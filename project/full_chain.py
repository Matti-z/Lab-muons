...
drive = True
xml_path = universal_dir("big_data/triple_delay_16_03_2026_14_17.xml")
...
if file == "root_parser":
    subprocess.run([universal_dir("project/bin/root_parser"), xml_path, root_path], capture_output=False)
